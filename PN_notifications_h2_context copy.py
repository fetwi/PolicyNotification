...
# chagne this code so that it only removes whatever is matched in a regex pattern from the content of the file and writes the modified content back to the file and matches using .DOTALL